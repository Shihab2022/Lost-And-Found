...
const myLostItem = catchAsync(async (req: Request, res: Response) => {
    const result = await CategoryService.myLostItem(req)
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
        message: "My Lost item get successfully",
        data: result
    })
})
const myFoundItem = catchAsync(async (req: Request, res: Response) => {
    const result = await CategoryService.myFoundItem(req)
    sendResponse(res, {
        statusCode: httpStatus.OK,
        success: true,
        message: "My found item get successfully",
        data: result
    })
})
